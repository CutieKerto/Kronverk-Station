...
job-description-boxer = Пробейтесь на вершину! Бросьте вызов начальнику смены и будьте арестованы когда выиграете. Эта должность доступна на станциях Core, Origin и Avrite.
job-description-brigmedic = Боритесь за жизни своих товарищей в тылу глобального охранного преприятия! Вы - первая и последняя надежда своего отряда. Да благословит вас Гиппократ.
job-description-cadet = Изучите основы задержания преступников и порядки преприятия. Прислушивайтесь к своим руководителям и не стесняйтесь обращаться за помощью.
job-description-captain = Управляйте станцией, распределяйте работу между другими начальниками смены и изъявляйте свою волю.
...
job-description-hos = Управляйте своими сотрудниками глобального охранного преприятия и следите за их эффективностью, подавляйте инакомыслие, и обеспечивайте безопасность других глав.
...
job-description-qm = Руководите погрузочно-разгрузочной компанией станции, контролируйте работу шахтеров, следите за выполнением всех заказов и обеспечивайте поступление денег.
