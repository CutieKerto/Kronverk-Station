...
ent-ClothingHeadHatBeretSecurity = берет ГОК
    .desc = Стильный вариант одежды для сотрудников ГОК.
...
ent-ClothingHeadHatBeretQM = берет оператора ПРК
    .desc = Берет с эмблемой отдела снабжения. Для ператоров ПРК, склонных к стилю.
ent-ClothingHeadHatBeretHoS = берет управляющего ГОК
    .desc = Чёрный берет с вышитой командирской эмблемой. Для офицеров, которые предпочитают стиль безопасности.
ent-ClothingHeadHatBeretWarden = берет надзирателя ГОК
...
ent-ClothingHeadHatFez = феска
    .desc = Красная феска.
ent-ClothingHeadHatHopcap = фуражка начальника смены
    .desc = Большая, стильная фуражка начальника смены.
ent-ClothingHeadHatHoshat = шляпа управляющего ГОК
...
ent-ClothingHeadHatCapcap = фуражка управляющего станцией
    .desc = Большая, стильная капитанская фуражка.
ent-ClothingHeadHatCentcomcap = фуражка ЦУС
