...
ent-ClothingBackpackSecurity = рюкзак ГОК
...
ent-ClothingBackpackCaptain = рюкзак управляющего станцией
...
ent-ClothingBackpackCargo = рюкзак грузчика ПРК
    .desc = Прочный рюкзак для воровства добычи.
ent-ClothingBackpackSalvage = рюкзак шахтера ПРК
