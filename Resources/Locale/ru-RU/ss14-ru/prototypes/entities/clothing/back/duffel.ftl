...
ent-ClothingBackpackDuffelCaptain = вещмешок управляющего станцией
...
ent-ClothingBackpackDuffelSecurity = вещмешок ГОК
    .desc = Большой вещмешок для хранения дополнительных припасов ГОК.
