...
ent-ClothingBackpackSatchelSecurity = сумка ГОК
    .desc = Прочная сумка для нужд ГОК.
ent-ClothingBackpackSatchelBrigmedic = сумка бригмедика
    .desc = Стерильная сумка для медицинских нужд.
ent-ClothingBackpackSatchelCaptain = сумка управляющего станцией
...
ent-ClothingBackpackSatchelCargo = сумка грузчика ПРК
    .desc = Прочная сумка для воровства добычи.
ent-ClothingBackpackSatchelSalvage = сумка шахтера ПРК
