...
ent-ClothingHeadsetCargo = гарнитура отдела ПРК
    .desc = Гарнитура, используемая сотрудниками отдела снабжения.
ent-ClothingHeadsetQM = гарнитура оператора ПРК
    .desc = Гарнитура, используемая оператором ПРК.
ent-ClothingHeadsetCentCom = гарнитура ЦУС
...
ent-ClothingHeadsetCE = гарнитура Мастера
    .desc = Гарнитура для мастера, с помощью которой он может игнорировать все экстренные вызовы.
...
ent-ClothingHeadsetSecurity = гарнитура ГОК
