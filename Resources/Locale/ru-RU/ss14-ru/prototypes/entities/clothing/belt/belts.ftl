...
ent-ClothingBeltChiefEngineer = пояс мастера
...
ent-ClothingBeltSecurity = пояс ГОК
    .desc = Может вмещать различное снаряжение ГОК, такое как наручники и вспышки.
...
ent-ClothingBeltSecurityWebbing = РПС ГОК
    .desc = Уникальный, универсальный разгрузочный жилет с ремнями и поясом, может вмещать снаряжение ГОК.
...
ent-ClothingBeltSalvageWebbing = РПС шахтера
